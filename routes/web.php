...
Route::middleware('auth')->group(function () {
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Test Database SIMADUN
    |--------------------------------------------------------------------------
    |
    | Route ini hanya sementara untuk memastikan Laravel dapat
    | membaca database db_simadun.
    |
    | Setelah koneksi berhasil, route ini akan dihapus.
    |--------------------------------------------------------------------------
    */

    Route::get('/test-simadun', function () {

        return DB::connection('simadun')
            ->select('SHOW TABLES');
    });
