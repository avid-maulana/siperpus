document.addEventListener("DOMContentLoaded", () => {
    ...
    const result = document.getElementById("thesisResult");
    const loading = document.getElementById("thesisSearchLoading");
    const clearButton = document.getElementById("thesisClearSearch");
    ...
    */
    ...
    async function loadTheses(page = 1, updateUrl = true) {
