...
<section class="relative -mt-20 overflow-hidden">
    ...
    {{-- Hero Content --}}
    <div class="relative mx-auto flex min-h-[500px] max-w-7xl
                items-center px-4 pb-24 pt-28
                sm:px-6 lg:px-8">
        ...
        <div class="grid w-full items-center gap-12
            ...
            <div class="max-w-3xl">
                ...
                <p class="mt-5 max-w-2xl text-base leading-8
                          text-slate-300 sm:text-lg">

                    Jelajahi koleksi buku, jurnal, modul, dan berbagai
                    referensi akademik berdasarkan judul, penulis,
                    tipe, maupun kategori untuk mendukung pembelajaran
                    dan penelitian.
                    ...
                    <div class="relative">
                        ...
                        <div class="mt-2 flex items-end gap-2">
                            ...
                            <h2 class="text-5xl font-bold tracking-tight
                                ...
                                @if ($totalLiteratures >= 1000000)
                                    {{ rtrim(rtrim(number_format($totalLiteratures / 1000000, 1, ',', ''), '0'), ',') }}M+
                                @elseif ($totalLiteratures >= 1000)
                                    {{ rtrim(rtrim(number_format($totalLiteratures / 1000, 1, ',', ''), '0'), ',') }}K+
                                @else
                                    {{ $totalLiteratures }}
                                @endif
                            ...
                            <span class="mb-1.5 text-sm font-semibold
                                         text-slate-500">
...
{{-- =========================================================
    SEARCH CARD
========================================================= --}}
<div class="relative z-20 mx-auto -mt-12 max-w-7xl
