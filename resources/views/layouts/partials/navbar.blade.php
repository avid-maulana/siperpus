...
<header
    ...
    <div
        ...
        <nav class="hidden items-center md:flex">
            ...
            <div
                class="mx-7 h-7 w-px bg-white/15">
            </div>
            ...
            <div
                class="relative flex h-[72px] items-center">
