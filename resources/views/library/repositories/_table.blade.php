...
<div
    class="mb-8
           ...
           bg-white
           shadow-sm"
    data-repository-section="without">
                        ...
                        <td class="px-6 py-5">
                            ...
                            <div
                                ...
                                <button
                                    ...
                                    data-id-pengajuan="{{ $item->id_pengajuan ?? '' }}"
...
<div
    class="mb-8
           ...
           bg-white
           shadow-sm"
    data-repository-section="needs-action">
...
<div
    class="mb-8
           ...
           bg-white
           shadow-sm"
    data-repository-section="active">
