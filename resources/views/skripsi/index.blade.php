...
<div class="min-h-screen bg-slate-50">
    ...
    <section class="relative -mt-20 overflow-hidden">
        ...
        <div class="relative mx-auto flex min-h-[500px] max-w-7xl
                items-center px-4 py-24 sm:px-6 lg:px-8">
                    ...
                    <div
                        ...
                        <div class="relative">
                            ...
                            <div class="mt-2 flex items-end gap-2">
                                ...
                                <span class="mb-1.5 text-sm font-semibold text-slate-500">
                                    Skripsi
                                </span>
                            ...
                            <p class="text-sm leading-6 text-slate-500">
                                Total koleksi skripsi mahasiswa yang tersedia di repository.
                            </p>
