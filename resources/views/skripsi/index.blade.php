...
@section('content')
    ...
    <div id="loading-bar" class="fixed
               left-0
               top-0
               z-[9999]
               h-1
    ...
    <div class="min-h-screen bg-slate-50">
        ...
        <section class="relative
            ...
            <img src="{{ asset('gambar/rak 3.png') }}" alt="Universitas Negeri Malang" class="absolute
                       inset-0
                       h-full
                       w-full
                       object-cover">
                    ...
                    <div class="hidden
                        ...
                        <div class="group
                            ...
                            <div class="absolute
                                       ...
                                       from-[#e8e4d5]
                                       to-[#fffdf4]
                                       shadow-[-3px_-3px_6px_rgba(0,0,0,0.06)]"></div>
        ...
        '.'
            ...
            <section id="skripsi-result" class="pb-16">
    ...
    @include('skripsi.pdf-viewer._pdf-viewer')
