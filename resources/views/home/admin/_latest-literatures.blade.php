...
<section class="rounded-2xl border border-slate-200
    ...
    <div class="flex items-center justify-between gap-4
        ...
        {{-- See All --}}
        <a href="{{ route('library.indexLiterature') }}" class="inline-flex shrink-0 items-center gap-1
    ...
    <div class="divide-y divide-slate-100">
        ...
        @forelse ($latestLiteratures as $literature)
            ...
            <a href="{{ route('literatures.index', ['search' => $literature->title]) }}" class="group flex items-center gap-4
                           px-6 py-4
                           transition hover:bg-slate-50">

                {{-- Cover --}}
                <div class="flex h-14 w-11 shrink-0
                    ...
                    @if ($literature->cover_url)
                        ...
                        <img src="{{ $literature->cover_url ?: asset('asset/cover.jpg') }}" alt="{{ $literature->title }}"
