...
@section('content')
    ...
    <div class="min-h-[calc(100vh-5rem)] bg-slate-50">
        <div class="mx-auto max-w-3xl px-6 py-10 lg:px-8">
            ...
            @if (session('success'))
                <div
                    class="mb-6 flex items-start gap-3 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-4 text-sm text-emerald-700">
            ...
            @if ($errors->any())
                <div
                    class="mb-6 flex items-start gap-3 rounded-2xl border border-red-200 bg-red-50 px-4 py-4 text-sm text-red-700">
                    <svg class="mt-0.5 h-5 w-5 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M12 9v3.75m9-1.5a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 4.5h.008v.008H12v-.008Z" />
                    </svg>
                    <div>
            ...
            <div class="overflow-hidden rounded-[24px] border border-slate-200 bg-white shadow-sm">
                ...
                <div class="border-b border-slate-200 px-6 py-6 sm:px-8">
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="username" type="text" value="{{ Auth::user()->username }}" readonly
                                    aria-readonly="true" tabindex="-1" class="{{ $readOnlyInputClass }}">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="email" type="text" value="{{ Auth::user()->email ?? 'Email belum tersedia' }}"
                                    readonly aria-readonly="true" tabindex="-1" class="{{ $readOnlyInputClass }}">
                                <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-4 text-slate-400"
                ...
                <form action="{{ route('profile.update') }}" method="POST" class="px-6 py-6 sm:px-8">
                    ...
                    <div class="space-y-5">
                        {{-- Current Password --}}
                        <div>
                            <label for="current_password" class="mb-2 block text-sm font-medium text-slate-700">Password
                                Lama</label>
                        ...
                        <div class="grid gap-5 sm:grid-cols-2">
                            <div>
                                <label for="password" class="mb-2 block text-sm font-medium text-slate-700">Password
                                    Baru</label>
                            ...
                            <div>
                                <label for="password_confirmation"
                                    class="mb-2 block text-sm font-medium text-slate-700">Konfirmasi Password</label>
                        ...
                        <div class="rounded-xl border border-blue-100 bg-blue-50/60 px-4 py-3">
                            <div class="flex gap-3">
                                <svg class="mt-0.5 h-4.5 w-4.5 shrink-0 text-blue-500" viewBox="0 0 24 24" fill="none"
